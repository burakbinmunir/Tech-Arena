<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchCode.aspx.cs" Inherits="Latest_Work.SearchCode" %>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-4">
                        <div class="image-wrapper">
                            <img src="portfolio/assets/images/mbr-1-696x464.jpg" alt="Code">
                        </div>
                    </div>
                    <div class="col-12 col-md">
                        <div class="card-box">
                            <h5 class="card-title mbr-fonts-style m-0 mb-3 display-5"><strong>Manage Your Projects From HErE!!&nbsp;&nbsp;</strong></h5>
                            <h6 class="card-subtitle mbr-fonts-style mb-3 display-4"><strong></strong></h6>
                            <p class="mbr-text mbr-fonts-style display-7">
                            </p>
                             <div class="navbar-buttons mbr-section-btn">
                                 <asp:TExtbox runat="server" ID="projectNameBox"   CssClass="form-control" Placeholder="Enter Project Name" ></asp:TExtbox>
                                 <br></br><br></br><br></br><br></br>
                                 <asp:Button runat="server" CssClass="btn btn-black display-4" Text="Search" OnClick="SearchCode_Click" />
                             </div>
                        </div>
                    </div>
                </div>
